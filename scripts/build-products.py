...
LINES = [
    dict(id="rose-hydrangea-bouquet", name="장미수국 꽃다발", cat="꽃다발",
         ...
         recipient=["연인", "배우자"], occasion=["기념일", "프러포즈", "생일"],
         giftType=["휴대전달형"],
    ...
    dict(id="hydrangea-bouquet", name="수국 꽃다발", cat="꽃다발",
         ...
         recipient=["연인", "친구", "부모님"], occasion=["생일", "기념일"],
         giftType=["휴대전달형"],
         situation="연인·친구·부모님 누구에게 드려도 부담 없는 무난한 꽃 선물을 찾을 때",
         reason="수국은 색이 은은해서 취향을 크게 타지 않고, 프리저브드라 오래 두고 볼 수 있어요."),

    dict(id="superior-rose", name="수페리어 장미", cat="꽃다발",
         match=dict(all=["수페리어"]),
         recipient=["연인", "배우자"], occasion=["프러포즈", "기념일"],
         giftType=["휴대전달형"],
    ...
    dict(id="rose-soap-bouquet", name="장미 비누꽃다발", cat="꽃다발",
         ...
         recipient=["연인", "배우자", "친구"], occasion=["생일", "기념일"],
         giftType=["휴대전달형"],
    ...
    dict(id="pinkpeach-bouquet", name="핑크피치 꽃다발", cat="꽃다발",
         match=dict(all=["핑크피치"]),
         recipient=["연인", "친구"], occasion=["생일", "기념일"],
         giftType=["휴대전달형"],
    ...
    dict(id="single-stem-soap-box", name="비누꽃 한송이·두송이 박스", cat="소품",
         ...
         recipient=["친구", "직장동료", "선생님"],
         occasion=["스승의날", "소소한 감사", "단체·답례품"],
         giftType=["휴대전달형", "단체·답례품"],
         situation="행사·모임에서 여러 명에게 하나씩 돌리거나, 가벼운 감사 인사를 전할 때",
    ...
    dict(id="glassdome-moodlamp", name="유리돔 무드등", cat="무드등",
         ...
         recipient=["연인", "배우자", "본인"], occasion=["기념일", "집들이·개업", "생일"],
         giftType=["인테리어형"],
         situation="선물한 뒤에도 방에 두고 매일 보게 되는 것을 찾을 때",
         reason="유리돔 안에 꽃을 담고 조명을 넣어, 꽃 선물이면서 동시에 인테리어 조명 역할을 해요."),
    ...
    dict(id="cup-moodlamp-single", name="프리저브드 꽃 무드등 한송이", cat="무드등",
         ...
         recipient=["연인", "친구", "본인"], occasion=["생일", "기념일"],
         giftType=["인테리어형"],
         situation="2만원대에서 오래 두고 볼 수 있는 선물을 찾을 때",
         reason="컵 모양 무드등에 꽃 한 송이를 담은 구성이라 책상이나 머리맡에 두기 좋은 크기예요."),
    ...
    dict(id="centerpiece", name="센터피스", cat="센터피스",
         match=dict(all=["센터피스"]),
         recipient=["부모님", "본인", "직장동료"], occasion=["집들이·개업", "생신·환갑"],
         giftType=["인테리어형"],
    ...
    dict(id="topiary-moodlamp", name="토피어리 수국 무드등", cat="무드등",
         match=dict(all=["토피어리"]),
         recipient=["연인", "부모님", "본인"], occasion=["집들이·개업", "생일", "기념일"],
         giftType=["인테리어형"],
    ...
    dict(id="hydrangea-moodlamp", name="수국꽃무드등", cat="무드등",
         ...
         recipient=["연인", "배우자", "부모님"], occasion=["기념일", "프러포즈", "생신·환갑"],
         giftType=["인테리어형"],
